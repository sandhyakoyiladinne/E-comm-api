    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        <div className="footer-column">
          <img
            src="https://previews.123rf.com/images/faysalfarhan/faysalfarhan1706/faysalfarhan170600435/80472328-ecommerce-icon-isolated-on-glassy-blue-round-button-abstract-illustration.jpg"
            alt="Shopping Logo"
